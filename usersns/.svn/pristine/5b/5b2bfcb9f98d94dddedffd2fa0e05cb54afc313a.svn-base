package com.newroad.user.sns.service.openmessage.lib.base;

import java.io.File;
import java.io.IOException;
import java.util.Map;

import com.newroad.user.sns.service.openmessage.lib.Mail;
import com.newroad.user.sns.service.openmessage.lib.Message;
...
import com.newroad.user.sns.service.openmessage.utils.RequestEncoder;
