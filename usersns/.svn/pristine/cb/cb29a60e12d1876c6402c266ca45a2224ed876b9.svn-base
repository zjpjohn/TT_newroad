package com.newroad.user.sns.service.openmessage.lib;

import com.newroad.user.sns.service.openmessage.lib.base.ISender;
import com.newroad.user.sns.service.openmessage.lib.base.SenderWapper;
import com.newroad.user.sns.service.openmessage.config.AppConfig;
import com.newroad.user.sns.service.openmessage.config.MailConfig;
import com.newroad.user.sns.service.openmessage.config.MessageConfig;
