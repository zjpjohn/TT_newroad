 ...
 */
@Deprecated
class MySSLSocketFactory implements LayeredSocketFactory {
    ...
    public MySSLSocketFactory(final KeyStore keystore, final String keystorePassword) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
    ...
    public Socket connectSocket(
        ...
        try {
            ...
            try { sslsock.close(); } catch (Exception x) { x.printStackTrace();}
            throw iox;
        }
