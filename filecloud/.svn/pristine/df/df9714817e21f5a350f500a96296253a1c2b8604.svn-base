...
public class FileNoteManageService implements FileStoreServiceIf {
  ...
  private CouchbaseCache superNoteCache;
  ...
  public void invalidateFileResource(String clientResourceID) {
    superNoteCache.delete(clientResourceID);
  ...
  public void setFileCache(String clientResourceID, CloudFileData fileCache) {
    superNoteCache.set(clientResourceID, fileCache, true);
  }

  public CloudFileData getFileCache(String clientResourceID) {
    Object obj = superNoteCache.get(clientResourceID);
    if (obj != null && obj instanceof CloudFileData) {
      return (CloudFileData) superNoteCache.get(clientResourceID);
    } else {
      return null;
    }
  }
  ...
  public void setSuperNoteCache(CouchbaseCache superNoteCache) {
    this.superNoteCache = superNoteCache;
  }
