package com.lenovo.fulltext.filter;
...
import com.lenovo.fulltext.service.SearchHttpClient;
import com.lenovo.fulltext.util.FullTextSearchConstants;
import com.lenovo.tool.log.RequestInfo;
import com.lenovo.tool.log.SPLogger;
...
public class TokenAuthFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		SPLogger.setCurrentRequest(new RequestInfo(req.getServerPort(), req
		...
		String token = req.getHeader(FullTextSearchConstants.TOKEN);
//		String uid = req.getHeader(FullTextSearchConstants.USERID);

		if (StringUtils.isBlank(token))
			token = req.getParameter(FullTextSearchConstants.TOKEN);
