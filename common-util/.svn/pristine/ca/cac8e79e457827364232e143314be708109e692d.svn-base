...
public class ApiReturnObjectUtil {
  ...
  public static JSONObject getReturn401() {
    return getReturnObj(ReturnCode.UNAUTHORIZED, ReturnCode.UNAUTHORIZED.name());
  }
  
  /**
   * 使用缺省的{@link ReturnCode#NO_TOKEN}获得返回码401对象
   * 
   * @return 形如:{"returnCode":402,"returnMessage:"NO_TOKEN"}
   */
  public static JSONObject getReturn402() {
