...
public class FileHelper {
  ...
  // 文件允许格式
  private static String[] allowFiles = {".rar", ".doc", ".docx", ".zip", ".pdf", ".txt", ".swf", ".wmv", ".gif", ".png", ".jpg", ".jpeg",
      ".bmp"};
  // 文件大小限制，单位KB
  ...
  public FileHelper(HttpServletRequest request) {
  ...
  public static String encodingFileName(String agent, String fileName) {
    if (fileName == null) {
      fileName = "undefined";
      return fileName;
    }
  ...
  public static void setAllowFiles(String[] allowFiles) {
    FileHelper.allowFiles = allowFiles;
  }
